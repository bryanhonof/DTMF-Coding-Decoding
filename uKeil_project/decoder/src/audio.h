...
//Using DMA
volatile uint32_t dma_tx_buffer_pong[DMA_BUFFER_SIZE] = { 0u }; 
volatile uint32_t dma_tx_buffer_ping[DMA_BUFFER_SIZE] = { 0u }; 
volatile uint32_t dma_rx_buffer_ping[DMA_BUFFER_SIZE] = { 0u }; 
volatile uint32_t dma_rx_buffer_pong[DMA_BUFFER_SIZE] = { 0u };
